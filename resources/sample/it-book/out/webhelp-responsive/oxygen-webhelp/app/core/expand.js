define(["options", "localization"], function (options, i18n) {
    ...
    $(document).ready(function () {
        ...
        function toggleSubtopics(state) {
            ...
            if (state !== undefined) {
                ...
                if (state == 'collapsed') {
                    ...
                    $('.wh_hide_subtopics').attr('data-next-state', 'expanded').attr('title', i18n.getLocalization('expandSections'));
                    $(this).removeClass('expanded');
                } else {
                    siblings.slideDown("1000");
                    $('.wh_hide_subtopics').attr('data-next-state', 'collapsed').attr('title', i18n.getLocalization('collapseSections'));
        ...
        $('.wh_hide_subtopics').click(function () {
            var state = $('.wh_hide_subtopics').attr('data-next-state');
